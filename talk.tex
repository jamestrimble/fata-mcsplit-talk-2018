...
\begin{columns}[T]
  \begin{column}{0.47\textwidth}
    ...
    \begin{center}\begin{tikzpicture}[scale=0.45]
        \node[draw, circle, fill=uofgpumpkin, inner sep=2.5pt, font=\bfseries] (Na) at (1,  0)
        {\vphantom{0}};
        \node[draw, circle, fill=uofgpumpkin, inner sep=2.5pt, font=\bfseries] (Nb) at (1, -2)
        {\vphantom{0}};
        \node[draw, circle, fill=uofgpumpkin, inner sep=2.5pt, font=\bfseries] (Nc) at (1, -4)
        {\vphantom{0}};
        \node[draw, circle, fill=uofgpumpkin, inner sep=2.5pt, font=\bfseries] (Nd) at (3, -4)
        {\vphantom{0}};
        \node[draw, circle, fill=white, inner sep=2.5pt, font=\bfseries] (Ne) at (3, -2)
        {\vphantom{0}};
  ...
  \begin{column}{0.47\textwidth}
    ...
    \begin{center}\begin{tikzpicture}[scale=0.45]
        ...
        \node[draw, circle, fill=uofgpumpkin, inner sep=2.5pt, font=\bfseries] (Nd) at (3, -4)
        {\vphantom{0}};
        \node[draw, circle, fill=uofgpumpkin, inner sep=2.5pt, font=\bfseries] (Ne) at (3, -2)
        {\vphantom{0}};
...
\begin{frame}{McSplit for Maximum Common Partial Subgraph?}
    \begin{itemize}
        \item 
    \end{itemize}
\end{frame}
